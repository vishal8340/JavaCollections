...
//	}
//
//	@Then("^user enters \"(.*)\" and \"(.*)\" and select \"(.*)\"$")
//	public void user_enters_username_password_and_select_tool(String username,String password,String tool ) {
//		wd.findElement(By.id("txtLoginID")).sendKeys(username);
//		wd.findElement(By.id("pwdKey")).sendKeys(password);
//		WebElement tools = wd.findElement(By.id("tool"));
//		Select slt = new Select(tools);
//		slt.selectByVisibleText(tool);
//
//	}
//
...
//		wd.findElement(By.xpath("//*[@title=\"Logout\"]")).click();
//		Thread.sleep(2000);
